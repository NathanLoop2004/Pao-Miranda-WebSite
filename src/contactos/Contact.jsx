...
export default function Contact() {
  ...
  return (
   ...
   {/* Section mapa */}
        <section className='pt-4 border-white h-133 lg:w-[50%]'>
          ...
          {/* Section Titulo */}
          <div className='bg-white  w-[100%] h-[45%] lg:h-[30%] flex justify-center'>
            <h1 className='font-[Montserrat,sans-serif] text-[24px] md:text-[30px] lg:text-[20px] lg:mt-5 leading-7 mx-11 mt-8 md:mt-15 text-justify tracking-tight text-[#1c242c]'>Si quieres trabajar con nosotros, solo déjanos una línea. Nos pondremos en contacto lo antes posible.</h1>
          </div>
...
<section className="relative h-67 w-[310px]  border-white md:h-[20%]  md:mx-auto lg:h-[40%] xl:h-[43%] lg:mt-4 lg:ml-5 md:-[100%]">
  {/* Imagen de fondo */}
